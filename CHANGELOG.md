...
- *(todo)* record splitting core into smaller crates ([#23](https://github.com/upwell-rs/upwell/pull/23))
- *(todo)* mark factory/manual macro unification ([#12](https://github.com/upwell-rs/upwell/pull/12)) complete
- *(todo)* record object-safe DescriptorRuntime for runtime introspection
- *(todo)* mark builtins ([#10](https://github.com/upwell-rs/upwell/pull/10)) and middleware ([#11](https://github.com/upwell-rs/upwell/pull/11)) complete
