...
- [X] T019 [P] [US1] Integration test in `tests/status_codes.rs`: a handler returning `Result<T, upwell_core::Error>` still compiles and maps to its mapped predefined category (regression). (SC-003)
