...
Today an Upwell RPC error is a bare string: a handler error collapses to its
...
Upwell (defining error types and handlers) and the developers consuming those
