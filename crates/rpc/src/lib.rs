...
/// Their generated code roots plugin types at this crate (`::upwell_rpc::*`) by default, or
...
/// The RPC app type: an [`App`](upwell_app::App) specialized to the native [`RpcPlugin`].
/// `App::builder(name)` resolves through this alias without a turbofish.
pub type App = upwell_app::App<RpcPlugin>;

/// The RPC app builder: [`AppBuilder`](upwell_app::AppBuilder) specialized to [`RpcPlugin`].
pub type AppBuilder = upwell_app::AppBuilder<RpcPlugin>;
