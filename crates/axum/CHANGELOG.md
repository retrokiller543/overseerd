...
## [0.20.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.19.1...upwell-axum-v0.20.0) - 2026-07-22
...
## [0.19.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.18.0...upwell-axum-v0.19.0) - 2026-07-21

### Added

- *(di)* add provider ordering and deferred primitives

## [0.18.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.17.2...upwell-axum-v0.18.0) - 2026-07-19

### Added

- *(axum)* make WebSocket protocols portable ([#105](https://github.com/upwell-rs/upwell/pull/105))

## [0.15.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.14.2...upwell-axum-v0.15.0) - 2026-07-17

### Fixed

- *(axum)* harden websocket and streaming clients

## [0.14.1](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.14.0...upwell-axum-v0.14.1) - 2026-07-17

### Added

- *(axum)* support opaque handler returns (Response / impl IntoResponse)

## [0.14.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.13.0...upwell-axum-v0.14.0) - 2026-07-17
...
## [0.13.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.12.1...upwell-axum-v0.13.0) - 2026-07-12
...
## [0.12.1](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.12.0...upwell-axum-v0.12.1) - 2026-07-08

### Added

- *(stomp)* implement Topic and TopicParam traits for Cow types

### Fixed

- *(stomp)* reorder import statements for clarity

## [0.12.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.11.2...upwell-axum-v0.12.0) - 2026-07-08
...
## [0.11.1](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.11.0...upwell-axum-v0.11.1) - 2026-07-07

### Added

- *(axum)* enhance multipart upload support with JS File/Blob integration

## [0.11.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.10.0...upwell-axum-v0.11.0) - 2026-07-07

### Added

- *(axum)* drop custom guards from client codegen; add query/raw/multipart bodies + per-call & transport headers

## [0.10.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.9.1...upwell-axum-v0.10.0) - 2026-07-03
...
## [0.9.1](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.9.0...upwell-axum-v0.9.1) - 2026-07-02

### Other

- added a way for rest handlers to publish stomp topics

## [0.9.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.8.0...upwell-axum-v0.9.0) - 2026-07-02
...
## [0.8.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.7.0...upwell-axum-v0.8.0) - 2026-07-02
...
## [0.7.0](https://github.com/upwell-rs/upwell/compare/upwell-axum-v0.6.0...upwell-axum-v0.7.0) - 2026-06-30
