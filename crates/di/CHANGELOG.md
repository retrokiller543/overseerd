...
## [0.20.0](https://github.com/upwell-rs/upwell/compare/upwell-di-v0.19.1...upwell-di-v0.20.0) - 2026-07-22

### Added

- *(di)* dual linkme/inventory registration backend for factories & hooks

## [0.19.0](https://github.com/upwell-rs/upwell/compare/upwell-di-v0.18.0...upwell-di-v0.19.0) - 2026-07-21
...
## [0.17.2](https://github.com/upwell-rs/upwell/compare/upwell-di-v0.17.1...upwell-di-v0.17.2) - 2026-07-18

### Other

- *(di)* isolate memory contract measurements

## [0.17.1](https://github.com/upwell-rs/upwell/compare/upwell-di-v0.17.0...upwell-di-v0.17.1) - 2026-07-17
...
## [0.16.0](https://github.com/upwell-rs/upwell/compare/upwell-di-v0.15.0...upwell-di-v0.16.0) - 2026-07-17

### Fixed

- *(runtime)* harden lifecycle, reloads, and filesystem safety ([#85](https://github.com/upwell-rs/upwell/pull/85))

## [0.14.2](https://github.com/upwell-rs/upwell/compare/upwell-di-v0.14.1...upwell-di-v0.14.2) - 2026-07-17

### Other

- *(di)* harden hot paths and add controlled benchmarks

## [0.12.0](https://github.com/upwell-rs/upwell/compare/upwell-di-v0.11.2...upwell-di-v0.12.0) - 2026-07-08
...
## [0.7.0](https://github.com/upwell-rs/upwell/compare/upwell-di-v0.6.0...upwell-di-v0.7.0) - 2026-06-30
