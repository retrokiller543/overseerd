...
## [0.20.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.19.1...upwell-axum-macros-v0.20.0) - 2026-07-22
...
## [0.18.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.17.2...upwell-axum-macros-v0.18.0) - 2026-07-19

### Added

- *(axum)* make WebSocket protocols portable ([#105](https://github.com/retrokiller543/upwell/pull/105))

## [0.15.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.14.2...upwell-axum-macros-v0.15.0) - 2026-07-17

### Fixed

- *(axum)* harden websocket and streaming clients

## [0.14.1](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.14.0...upwell-axum-macros-v0.14.1) - 2026-07-17

### Added

- *(axum)* support opaque handler returns (Response / impl IntoResponse)

## [0.14.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.13.0...upwell-axum-macros-v0.14.0) - 2026-07-17
...
## [0.12.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.11.2...upwell-axum-macros-v0.12.0) - 2026-07-08
...
## [0.11.2](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.11.1...upwell-axum-macros-v0.11.2) - 2026-07-07

### Fixed

- *(axum)* never drop client methods for guard-consumed path params

## [0.11.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.10.0...upwell-axum-macros-v0.11.0) - 2026-07-07

### Added

- *(axum)* drop custom guards from client codegen; add query/raw/multipart bodies + per-call & transport headers

## [0.10.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.9.1...upwell-axum-macros-v0.10.0) - 2026-07-03
...
## [0.9.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.8.0...upwell-axum-macros-v0.9.0) - 2026-07-02

### Added

- *(axum)* DI-backed middleware registration + RequestMeta request-scope seed

## [0.8.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.7.0...upwell-axum-macros-v0.8.0) - 2026-07-02
...
## [0.7.0](https://github.com/retrokiller543/upwell/compare/upwell-axum-macros-v0.6.0...upwell-axum-macros-v0.7.0) - 2026-06-30
